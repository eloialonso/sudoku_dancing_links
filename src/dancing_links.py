...
def dlx(a: Matrix2D) -> Generator[Solution, None, None]:  # Knuth's Algorithm X implemented with Dancing Links
...
def apply_loop(func: Callable, head: Cell, direction: str) -> Generator[Any, None, None]:
...
def unplug(cell: Cell, direction: str) -> None:
    if direction == 'h': cell.l.r, cell.r.l = cell.r, cell.l
    elif direction == 'v': cell.u.d, cell.d.u = cell.d, cell.u
    else: raise ValueError


def replug(cell: Cell, direction: str) -> None:
    if direction == 'h': cell.l.r, cell.r.l = cell, cell
    elif direction == 'v': cell.d.u, cell.u.d = cell, cell
    else: raise ValueError
